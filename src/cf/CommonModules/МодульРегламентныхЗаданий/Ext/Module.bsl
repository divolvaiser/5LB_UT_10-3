...
Процедура ВыполнитьОтложенныеДвижения() Экспорт
	//#***+Добавления*** Тасмаджиев 21/11/2018// ->>
	
	ИмяПланаОбмена = "ОбменУправлениеТорговлейРозничнаяТорговля";
	КодОтКого = "002";
	УзелОбменаЗагрузкаДанных = ПланыОбмена[ИмяПланаОбмена].НайтиПоКоду(КодОтКого);
	_5LB_ОбменДаннымиXML = Обработки._5LB_ОбменДаннымиXML.Создать();
	_5LB_ОбменДаннымиXML.УзелОбменаЗагрузкаДанных = УзелОбменаЗагрузкаДанных;
	_5LB_ОбменДаннымиXML.ВыполнитьОтложенныеОперацииСДокументами("", Ложь, 0,Неопределено); 
	
КонецПроцедуры //#***-Добавления*** Тасмаджиев 21/11/2018// <<-
