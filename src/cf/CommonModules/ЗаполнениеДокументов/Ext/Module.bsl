...
//pryan@inbox.ru 11/10/2013
				если ТипЗнч(ДокументОбъект) = Тип("ДокументОбъект.ОприходованиеТоваров") или ТипЗнч(ДокументОбъект) = Тип("ДокументОбъект.СписаниеТоваров") тогда
					сообщить("Товар: "+СтрокаТаблицы.Номенклатура);	
				конецесли;
//pryan@inbox.ru 11/10/2013
			КонецЕсли;
