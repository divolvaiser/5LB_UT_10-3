...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	|	ЕСТЬNULL(ТоварыВРезервеНаСкладахОстатки.КоличествоОстаток, 0) * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент КАК ОстатокРезерв,
	|	ИсточникДанных.КоличествоКонечныйОстаток * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент - ЕСТЬNULL(ТоварыВРезервеНаСкладахОстатки.КоличествоОстаток, 0) * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент КАК СвободныйОстаток
	|{ВЫБРАТЬ
	|	Склад.*,
	|	Номенклатура.*,
	...
	//pryan@inbox.ru 15/08/2015
	УниверсальныйОтчет.ДобавитьПолеРесурс("ОстатокРезерв",            "ОстатокРезерв", "Количество (в базовых единицах) (резерв)");
	...
	//pryan@inbox.ru 15/08/2015
	УниверсальныйОтчет.ДобавитьПоказатель("ОстатокРезерв",         "Резерв",       Ложь, "ЧЦ=15; ЧДЦ=3", "КолБазовыхЕд", "Количество (в базовых единицах)");
