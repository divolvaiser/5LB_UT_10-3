...
Процедура СформироватьОтчет(Диаграмма, ЕстьОшибки = Ложь)	Экспорт
	...
	Если Диаграмма.Имя = "Диаграмма1" Тогда
		ИмяВыводимогоПоказателя = "КоличествоЗаказСРеализ"; 
	Иначе
	...
	Если Диаграмма.Имя = "Диаграмма1" Тогда
	ИмяПоказателя = "КоличествоЗаказСРеализ";
	Иначе
	...
	Попытка
		...
		//Если мНазваниеОтчета = "Отгруженные Заказы" Тогда
		//	УправлениеОтчетами.ОбработкаПоказателейДобавитьВВыбранныеПоля("КоличествоЗаказСРеализ", ПостроительОтчета);
		//КонецЕсли;
	Исключение
	КонецПопытки;
