...
// в течение периода отчета.
	...
	|					ТОГДА ПродажиОбороты.ДокументПродажи = СписокРегистраторов.Сделка
	|					ИНАЧЕ	ВЫБОР	КОГДА ПродажиОбороты.ДоговорКонтрагента.ВедениеВзаиморасчетов = ЗНАЧЕНИЕ(Перечисление.ВедениеВзаиморасчетовПоДоговорам.ПоЗаказам)
