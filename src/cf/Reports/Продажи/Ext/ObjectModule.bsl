...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьОтбор("ДокументПродажи.Организация");
...
//pryan@inbox.ru 15/02/2014
	//УниверсальныйОтчет.СформироватьОтчет(ТабличныйДокумент,,,"Продажи");
    ПараметрБонусыПродавцам = новый Структура("БонусыПродавцам,ВыводитьБонусы,ВыводитьСмены,ВыводитьПродажи,ВыводитьПроценты,ВыводитьУценку,ИнтернетМагазин");
	ПараметрБонусыПродавцам.БонусыПродавцам = БонусыПродавцам;
	ПараметрБонусыПродавцам.ВыводитьБонусы = ВыводитьБонусы;
	ПараметрБонусыПродавцам.ВыводитьСмены = ВыводитьСмены;
	ПараметрБонусыПродавцам.ВыводитьПродажи = ВыводитьПродажи;
	ПараметрБонусыПродавцам.ВыводитьПроценты = ВыводитьПроценты;
	ПараметрБонусыПродавцам.ВыводитьУценку = ВыводитьУценку;
	ПараметрБонусыПродавцам.ИнтернетМагазин = ИнтернетМагазин;
	
	УниверсальныйОтчет.СформироватьОтчет(ТабличныйДокумент,,,"Продажи",ПараметрБонусыПродавцам,ПолучитьМакет("БонусыПродавцам"));
...
//pryan@inbox.ru 15/02/2014
	...
	ПараметрБонусыПродавцам = новый Структура("БонусыПродавцам,ВыводитьБонусы,ВыводитьСмены,ВыводитьПродажи,ВыводитьПроценты,ВыводитьУценку,Макет");
	ПараметрБонусыПродавцам.БонусыПродавцам = БонусыПродавцам;
	ПараметрБонусыПродавцам.ВыводитьБонусы = ВыводитьБонусы;
	ПараметрБонусыПродавцам.ВыводитьСмены = ВыводитьСмены;
	ПараметрБонусыПродавцам.ВыводитьПродажи = ВыводитьПродажи;
	ПараметрБонусыПродавцам.ВыводитьПроценты = ВыводитьПроценты;
	ПараметрБонусыПродавцам.ВыводитьУценку = ВыводитьУценку;
	если ВыводитьУценку тогда
		ПараметрБонусыПродавцам.Макет = ПолучитьМакет("РасшифровкаБонусыПродавцамУценка");
	иначе	
		ПараметрБонусыПродавцам.Макет = ПолучитьМакет("РасшифровкаБонусыПродавцам");
	конецесли;	
	
	УниверсальныйОтчет.ОбработкаРасшифровкиУниверсальногоОтчета(Расшифровка, Объект, ДополнительныеПараметры, ПараметрБонусыПродавцам);
