...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	|	ТоварыВРезервеНаСкладах.КоличествоОстаток КАК СоСклада,
	...
	|	ТоварыВРезервеНаСкладах.КоличествоОстаток * ВнутренниеЗаказыОстаткиИОбороты.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент                           КАК СоСкладаБазовыхЕд,
	...
	|		/ ТоварыВРезервеНаСкладах.Номенклатура.ЕдиницаДляОтчетов.Коэффициент          КАК СоСкладаЕдиницОтчетов,
	...
	|	ТоварыВРезервеНаСкладах.КоличествоОстаток
	|		* ТоварыВРезервеНаСкладах.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент
	|		/ ВнутренниеЗаказыОстаткиИОбороты.ЕдиницаИзмерения.Коэффициент          КАК СоСкладаЕдиницЗаказа,
	|	РазмещениеЗаказовПокупателей.КоличествоОстаток
	|		* РазмещениеЗаказовПокупателей.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("Запланировано",      "Запланировано");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗапланированоБазовыхЕд",      "Запланировано (в базовых ед.)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗапланированоЕдиницОтчетов",      "Запланировано (в ед. отчетов)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗапланированоЕдиницЗаказа",      "Запланировано (в ед. заказа)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("Запланировано",      "Запланировано",       		Истина, "ЧЦ=15; ЧДЦ=3", "Выполнение", "Выполнение (в ед. хранения)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("Заказано",           "Заказано",            		Истина, "ЧЦ=15; ЧДЦ=3", "Выполнение", "Выполнение (в ед. хранения)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоБазовыхЕд",      "Запланировано",       		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеБазовыхЕд", "Выполнение (в базовых ед.)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноБазовыхЕд",           "Заказано",            		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеБазовыхЕд", "Выполнение (в базовых ед.)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоЕдиницОтчетов",      "Запланировано",        		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницОтчетов", "Выполнение (в ед. отчетов)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноЕдиницОтчетов",           "Заказано",             		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницОтчетов", "Выполнение (в ед. отчетов)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ЗапланированоЕдиницЗаказа",      "Запланировано",        		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницЗаказа", "Выполнение (в ед. заказа)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ЗаказаноЕдиницЗаказа",           "Заказано",             		Ложь, "ЧЦ=15; ЧДЦ=3", "ВыполнениеЕдиницЗаказа", "Выполнение (в ед. заказа)");
