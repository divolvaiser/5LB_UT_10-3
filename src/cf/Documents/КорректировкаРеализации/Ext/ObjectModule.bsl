...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ЗаполнитьЗаказПокупателяВТЧ(ВидОперации,ЭтотОбъект, "Реализация");
	//***{-Добавления}*** Тасмаджиев 06/08/2018// <<-
...
Процедура ЗаполнитьЗаказПокупателяВТЧ(ДокументВидОперации, ДокументОбъект, ВидОперации) Экспорт
	ЕстьКолонкаЗаказ = УправлениеЗаказами.ЕстьЗаказВТабличнойЧасти(ДокументВидОперации, ДокументОбъект.ДоговорКонтрагента, ВидОперации);
...
КонецПроцедуры //***{-Добавления}*** Тасмаджиев 06/08/2018// <<-
