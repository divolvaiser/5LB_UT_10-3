...
Функция ВыгрузитьПоПравилу(Источник					= Неопределено,
	...
	Если НеНужноВыгружатьПоСоответствиюЗначений Тогда
		...
		Если ПКО.СвойстваПоиска.Количество() > 0 
			...
			ВыгрузитьТолькоСсылку = ПКО.НеВыгружатьОбъектыСвойствПоСсылкам;
			//Изменено//////////////////////
			//Автор: Тасмаджиев 27/12/2017//
			//-КОНЕЦ-//////////////////////
...
Процедура ЗаписатьИнформациюОбОтложенныхДвижениях(СсылкаНаОбъект, ДатаДокумента, ИнформацияОбОшибке = "", НомерОшибкиПроведения = 0) Экспорт
