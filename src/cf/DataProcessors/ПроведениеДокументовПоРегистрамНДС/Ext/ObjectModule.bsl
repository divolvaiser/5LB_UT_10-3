...
Процедура ОчиститьДвиженияРегистровНДС(ДокументОбъект)
	...
	Для Каждого Движение Из ДокументОбъект.Движения Цикл
		...
		Если ТипЗнч(Движение) = Тип("РегистрНакопленияНаборЗаписей.НДСВключенныйВСтоимость")
		 ...
		 ИЛИ ТипЗнч(Движение) = Тип("РегистрНакопленияНаборЗаписей.НДСЗаписиКнигиПокупок") Тогда
...
Процедура ПровестиДокументыПоРегистрамНДС()
	...
	Перем ТаблицаПоТоварам, ТаблицаПоТоварамВалюта, ТаблицаПоПрочее, ТаблицаПоУслугам, ТаблицаПоТаре;
	...
	Пока ДокументВыборка.Следующий() Цикл
		...
		Отказ = Ложь;
		ДокументОбъект.ПодготовитьСтруктуруШапкиДокумента(Заголовок, СтруктураШапкиДокумента);
		ДокументОбъект.ПодготовитьТаблицыДокумента(СтруктураШапкиДокумента, ТаблицаПоУслугам, ТаблицаПоТоварам);
	...
	Пока ДокументВыборка.Следующий() Цикл
		...
		Если Не ДокументВыборка.НаАванс Тогда
			Продолжить;
		КонецЕсли;
		...
		УчетНДСФормированиеДвижений.СформироватьДвиженияНДС_СчетФактураВыданный(СтруктураШапкиДокумента, ТаблицаАвансов, ДокументОбъект.Движения);
