...
Функция ВыгрузитьПоПравилу(Источник					= Неопределено,
	...
	Если Приемник = Неопределено Тогда
		...
		//{+НАЧАЛО+Изменения} Автор: Тасмаджиев 14/02/2018//==============================================================================================
		Если  ЗначениеЗаполнено(ВыгрузкаСтрокиНабораЗаписейрегистра) Тогда //Добавил еще одно условие для ВыгрузитьПоПравилу(), а то с ошибкой валилось.
			Если НЕ ВыгрузкаСтрокиНабораЗаписейрегистра Тогда
				...
				КонецЕсли;
			КонецЕсли;	
			//{+НАЧАЛО+Добавления} Автор: Тасмаджиев 14/02/2018//==============================================================================================
		...
		Иначе
			...
			Если Не ПустаяСтрока(РежимЗаписи) Тогда
				...
				Если Не ПустаяСтрока(РежимПроведения) Тогда
					УстановитьАтрибут(Приемник, "РежимПроведения",	РежимПроведения);
				КонецЕсли;
				//{-КОНЕЦ-Добавления} Автор: Тасмаджиев 14/02/2018//==============================================================================================
				//{-КОНЕЦ-Изменения} Автор: Тасмаджиев 14/02/2018//==============================================================================================
