...
Процедура ВыполнитьОбновление() Экспорт
	...
	ВозможныеВерсииДляПерехода = """10.2.13"", ""10.3.1"", ""10.3.2"", ""10.3.3"", ""10.3.4"", ""10.3.5"", ""10.3.6"", ""10.3.7"", ""10.3.8""";
	...
	Если ТекущаяВерсияИБ = "10.3.6.8" Тогда
		...
		// Установка номера версии информационной базы
		Константы.НомерВерсииКонфигурации.Установить(НоваяВерсияИБ);
		выборкаУзловОбмена = ПланыОбмена.ОбменУправлениеТорговлейБухгалтерияКОРП.Выбрать();
	...
	Если ТекущаяВерсияИБ = "10.3.7.9"
	 ИЛИ (НомерРелиза = "10.3.8" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		// Программный код который необходимо выполнить при переходе с версии 10.3.7.8 на версию 10.3.8
		//
	...
	Если (НомерРелиза = "10.3.8" И ТекущаяВерсияИБ <> НоваяВерсияИБ) Тогда
		...
		// Программный код который необходимо выполнить при переходе с версии 10.3.8.7 на версию 10.8.8
		//
...
//////////////////////////////////////////////////////////////////////////
	...
	//++ Кузнецов С.А. - Убрал "10.3.8" - 03.12.2015	
	Если Найти("""10.3.2"", ""10.3.3"", ""10.3.5"", ""10.3.6"", ""10.3.7""", ТекущийНомерРелиза) <> 0 Тогда
		ТребуетсяЗапускПакетаОбработокОбновленияКонфигурации = Истина;
	КонецЕсли;
	//-- Кузнецов С.А. - 03.12.2015
